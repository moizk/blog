...
Last year, I put together a post that outlined my goals for 2014. It was really helpful as it forced me to collect my thoughts, make specific goals and I read the post often throughout the year to see how I was doing. I’ll start with a retrospective about Campusvine.
...
It’s important to keep friends who act as gadflies. They keep you sharp and remind you of your faults. 
...
By November 2012, I had learned enough about Rails to begin contributing, but by that time we didn’t have enough money pay our employees. Alex began looking for a full time job. That left me in a situation as the only one who worked on Campusvine as my primary focus. But I also had to find work to pay my bills and rent.
...
I’ve removed large components of Bootstrap, and you wouldn’t know that we’re using Bootstrap unless you looked at the class names. I decided that the shared knowledge of Bootstrap was better than attempting to write an entire CSS framework. 
...
At the beginning of 2014, I was a contractor for Nooklyn, By the end of the year, I’ve negotiated a 33% ownership stake and am the CTO. It’s been a hell of a year.

Here’s what I listed as my 2014 goals for Nooklyn.

1. Enable people to explore places in a neighborhood (specifically Bushwick).
2. Build roommate finding functionality.
3. 500k+ visits, 5k registered users, 10k+ likes.
4. Release a simple Nooklyn iPhone App.

I’ve accomplished 2/4 with the other 2/4 currently in progress, and will be completed in early 2015. 

Enabling people to explore a neighborhood has been an interesting challenge. I’ve spent the last year going back and forth on how to accomplish it. I’ve said no to a lot of good ideas that weren’t good enough. That’s something I’m very proud of. I really look forward to releasing Nooklyn’s Bushwick Neighborhood Guide in early 2015. It’s going to be amazing.

I built the roommate finder (Rooms & Mates), and it was incredibly successful. In 5 months, nearly 600 unique individuals created created a post, and a couple thousand messaged someone. I’ve learned a lot, and I’m going to launch a redesign of Rooms & Mates in 2015.

The numbers were too conservative. We had over 1.4 million page views, 6,800 registered users and 11k likes.

I’m currently working on an iPhone app. I forgot what it was like to be a newbie at something. Developing this app (and therefore learning Objective-C, Swift and Apple’s Frameworks) has been a fun challenge. I’ve rode the roller coaster of despair to moments of sheer delight. I think I can release the app in February 2015.

I also accomplished a lot of unexpected things with Nooklyn in 2014.

I met an incredible designer, [Daniel](https://dribbble.com/DanielHaire) and he’s produced amazing work. I’m incredibly excited every time I get a sneak peak at a new project. I’ve worked with him on a new logo for Nooklyn, illustrations, an icon set, stickers, letterhead, holiday cards and even a short animated video. 

I hired [Patrice](http://www.lgtrproductions.com/) for an amazing Nooklyn Rooms & Mates video. I worked with Patrice during college, and she remains to be an amazing person to work with. 

I was able to hire [Alex](http://binaryclass.com/) as a contractor to accomplish technical projects for Nooklyn.

I got to manage digital advertising for Nooklyn, which included using Facebook’s Ad Platform, Google’s AdWords for Search/YouTube, and Twitter’s Ads. 

### Goals for 2015

1. Release iPhone app.
2. Release the Bushwick Neighborhood guide.
3. Redesign Rooms & Mates.
4. Rewrite photo uploading functionality.
5. Create Messaging functionality.
6. Begin accepting some paperwork online.
7. 10k Users, 5 million page views, 2k Rooms & Mates Posts, 20k likes, 1k iOS app installs.

I’m incredibly excited for the future.

## Personal Goals

This was my list of goals for 2014.

1. Create and release a CSS Framework
2. Write and publish something every two weeks
3. Design, program and ship an iOS app
4. Become good at JavaScript/jQuery
5. Learn EmberJS and attend Ember Camp in Portland
6. Post a design on Dribbble every month
7. Create my first icon set
8. Travel to San Francisco during the Spring/Summer time. 

I accomplished 0/8, though, most of them are in progress or were due to shifting priorities.

I’ve been working on Kublai (my CSS Framework) and I’ve included in 4 different projects to battle test it in different environments. The only component I use from Bootstrap is their grid. 

I’ve found that because I never schedule time to write, I never do it. That’s something I’ll change in 2015.

I did design an iOS app, and am currently programming it, and will ship it in early 2015.

I’ve become decent at JavaScript, not as good as I’d like, but I probably need an ambitious project to spend time on. If I can end 2015 being as good at JavaScript as I am at Ruby, that would be awesome.

I didn’t learn EmberJS and don’t foresee it happening in 2015. I think it’s still too early in the world of JavaScript frameworks to spend time learning one. 

I didn’t do nearly as much design work as I’d like with Dribbble, though that is primarily because I hired a designer to work on Nooklyn, and focused more heavily on the engineering/project management side.

While I didn’t create an icon set, I did get one made for Nooklyn. That’s at least half a point.

I didn’t get the time to travel to SF during the Spring/Summer, but I am going on January 9th, 2015. Better late than never.

I also accomplished a few unexpected personal goals in 2014.

1. Financial stability. (I have a rainy day fund)
2. Joined a gym and lost 25lbs. (sweet baby jesus)
3. Kept my own apartment, without a roommate.

### 2015 Goals

1. Travel to Japan in the Spring. Konichiwa Bitches.
2. Release the Nooklyn iPhone app.
3. Lose another 25lbs.
4. Schedule a time to write/publish something every week.
5. Travel to Japan in the Spring. Konichiwa Bitches.
